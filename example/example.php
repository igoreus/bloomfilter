...
use \Igoreus\BloomFilter\Persist\CRedisCbfModule;
use \Igoreus\BloomFilter\BloomFilter;
use \Igoreus\BloomFilter\CountingBloomFilter;
...
$db = new PDO('mysql:host=localhost;dbname=iconic', 'root', '');
$redis = new \Redis();
...
$filters = [
    'Redis Module' => CountingBloomFilter::createFromApproximateSize(CRedisCbfModule::create(['port' => 7777]), 10000, 0.001, true),
